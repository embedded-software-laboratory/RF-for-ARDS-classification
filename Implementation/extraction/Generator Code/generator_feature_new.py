...
#with open("../../../Data/Databases/avg_all.txt","r") as file_avg_values:
#    lines_avg_values = [line.rstrip().replace('\r','').replace('\n','') for line in file_avg_values]
#del line_names[0]
...
#        
#        if float(lines_avg_values[j]) < cutoff and not float(lines_avg_values[j]) < last_cutoff :
